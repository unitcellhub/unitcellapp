...
# from dashboard import OPTIONS_NORMALIZE
...
from dashboard.customeval import customeval
import json
import base64
import numpy as np
import pandas as pd
...
from unitcell.geometry.sdf import SDFGeometry, GRAPH_DEF
...
def _createSubCardProps(unitcell, L, W, H, T, R, form, scustom, ssurrogate):
    ...
    try:
        ...
        calcs = {"length": L, "width": W, "height": H, "thickness": T}
        X = np.array([[L, W, H, T]])
        rows = [
            html.Tr(
