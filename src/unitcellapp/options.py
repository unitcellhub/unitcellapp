...
_OPTIONS = dict(
    ...
    G12=dict(
        name="Rel. shear modulus on face X in direction Y",
        info="Defines the effective shear modulus of the unit cell on the 'X' face in the 'Y' direction. This quantity is normalized according to the elastic modulus of the base material. For example, to specialize this parameter for an aluminum lattice, you would simply multiple this value by the shear modulus of aluminum (68 GPa).",
        ref=["homogenizedStiffness"],
        calc=lambda ref: Gij(ref[0], [0, 1, 0], [1, 0, 0]),
    ),
    G23=dict(
        name="Rel. shear modulus on face Y in direction Z",
        info="Defines the effective shear modulus of the unit cell on the 'Y' face in the 'Z' direction (G<sub>yz<\sub>). This quantity is normalized according to the elastic modulus of the base material. For example, to specialize this parameter for an aluminum lattice, you would simply multiple this value by the shear modulus of aluminum (68 GPa).",
        ref=["homogenizedStiffness"],
        calc=lambda ref: Gij(ref[0], [0, 0, 1], [0, 1, 0]),
    ),
    G13=dict(
        name="Rel. shear modulus on face X in direction Z",
        info="Defines the effective shear modulus of the unit cell on the 'X' face in the 'Z' direction (G<sub>xz<\sub>). This quantity is normalized according to the elastic modulus of the base material. For example, to specialize this parameter for an aluminum lattice, you would simply multiple this value by the shear modulus of aluminum (68 GPa).",
        ref=["homogenizedStiffness"],
        calc=lambda ref: Gij(ref[0], [0, 0, 1], [1, 0, 0]),
    ),
    Gmin=dict(
    ...
    nu12=dict(
        ...
        info="Defines the effective Poisson's ratio of the unit cell on the 'X' face in the 'Y' direction (ν<sub>xy<\sub>).",
        ref=["homogenizedStiffness"],
        calc=lambda ref: nuij(ref[0], [0, 1, 0], [1, 0, 0]),
    ),
    nu23=dict(
        name="Poisson's ratio on face Y in direction Z",
        info="Defines the effective Poisson's ratio of the unit cell on the 'Y' face in the 'Z' direction (ν<sub>yz</sub>).",
        ref=["homogenizedStiffness"],
        calc=lambda ref: nuij(ref[0], [0, 0, 1], [0, 1, 0]),
    ),
    nu13=dict(
        name="Poisson's ratio on face X in direction Z",
        info="Defines the effective Poisson's ratio of the unit cell on the 'X' face in the 'Z' direction (ν<sub>xz</sub>).",
        ref=["homogenizedStiffness"],
