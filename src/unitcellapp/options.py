...
_OPTIONS = dict(
    ...
    G12=dict(
        ...
        info="Defines the effective shear modulus of the unit cell on the 'X' face in the 'Y' direction (Gxy). This quantity is normalized according to the elastic modulus of the base material. For example, to specialize this parameter for an aluminum lattice, you would simply multiple this value by the shear modulus of aluminum (68 GPa).",
        ref=["homogenizedStiffness"],
        calc=lambda ref: Gij(ref[0], [0, 1, 0], [1, 0, 0]),
    ),
    G23=dict(
        name="Rel. shear modulus on face Y in direction Z",
        info="Defines the effective shear modulus of the unit cell on the 'Y' face in the 'Z' direction (Gyz). This quantity is normalized according to the elastic modulus of the base material. For example, to specialize this parameter for an aluminum lattice, you would simply multiple this value by the shear modulus of aluminum (68 GPa).",
        ref=["homogenizedStiffness"],
        calc=lambda ref: Gij(ref[0], [0, 0, 1], [0, 1, 0]),
    ),
    G13=dict(
        name="Rel. shear modulus on face X in direction Z",
        info="Defines the effective shear modulus of the unit cell on the 'X' face in the 'Z' direction (Gxz). This quantity is normalized according to the elastic modulus of the base material. For example, to specialize this parameter for an aluminum lattice, you would simply multiple this value by the shear modulus of aluminum (68 GPa).",
        ref=["homogenizedStiffness"],
